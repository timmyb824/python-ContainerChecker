...
class TestContainers(unittest.TestCase):
    ...
    def test_check_installed_package(self):
        ssh_client = Mock()
        ssh_client.exec_command.return_value = (None, Mock(read=lambda: b'package_name'), None)
    ...
    def test_get_running_containers(self):
        ...
        ssh_client = Mock()
        ssh_client.exec_command.return_value = (None, Mock(read=lambda: b'container1 123\ncontainer2 456'), None)
        ...
        ssh_client.exec_command.return_value = (None, Mock(read=lambda: b'container3 789'), None)
